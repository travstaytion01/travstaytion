    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://www.instagram.com/travstaytion?igsh=NGJlamNzc2loY3I3" className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-blue-600 transition-colors">
              ...
              <a href="https://www.facebook.com/share/17hFsLkWbC/" className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-blue-600 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              <li className="flex items-center space-x-3">
                <div className="w-10 h-10 bg-gradient-to-br from-blue-500 to-teal-400 rounded-full flex items-center justify-center flex-shrink-0">
                  <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>
                </div>
                <span className="font-medium text-white">GST: 09DPCPK2869P1Z3</span>
              </li>
              <li className="flex items-center space-x-3">
                <a href="mailto:Holidays@travstaytion.com" className="flex items-center space-x-3 hover:text-white transition-colors">
                  ...
                  <span>Holidays@travstaytion.com</span>
                </a>
              </li>
              <li className="flex items-center space-x-3">
              ...
              <li className="flex items-start space-x-3">
                <a href="https://www.google.com/maps/place/NewPinch+Boutique%2FStore/@28.6571289,77.4323323,788m/data=!3m1!1e3!4m6!3m5!1s0x390cf104ee2e2569:0x7817fa950e1c401!8m2!3d28.6571243!4d77.4369457!16s%2Fg%2F11xz50rp43?entry=ttu&g_ep=EgoyMDI1MTIwOS4wIKXMDSoASAFQAw%3D%3D" target="_blank" rel="noopener noreferrer" className="flex items-start space-x-3 hover:text-white transition-colors">
                  <div className="w-10 h-10 bg-gradient-to-br from-blue-500 to-teal-400 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} TravStaytion. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
