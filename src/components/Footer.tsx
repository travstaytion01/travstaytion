...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#091525] text-white" role="contentinfo">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-12 lg:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-12">
          ...
          <div className="sm:col-span-2 lg:col-span-2">
            ...
            <div className="flex space-x-3 sm:space-x-4" role="list" aria-label="Social media links">

              <a href="https://www.instagram.com/travstaytion?igsh=NGJlamNzc2loY3I3" className="w-10 h-10 sm:w-11 sm:h-11 bg-gray-800 rounded-full flex items-center justify-center hover:bg-gradient-to-r hover:from-pink-500 hover:to-purple-500 transition-all duration-300 hover:scale-110 active:scale-95 focus:outline-none focus:ring-2 focus:ring-pink-400 touch-manipulation" aria-label="Follow us on Instagram" target="_blank" rel="noopener noreferrer">
              ...
              <a href="https://www.facebook.com/share/17hFsLkWbC/" className="w-10 h-10 sm:w-11 sm:h-11 bg-gray-800 rounded-full flex items-center justify-center hover:bg-blue-600 transition-all duration-300 hover:scale-110 active:scale-95 focus:outline-none focus:ring-2 focus:ring-blue-400 touch-manipulation" aria-label="Follow us on Facebook" target="_blank" rel="noopener noreferrer">
        ...
        <div className="border-t border-gray-800 mt-8 sm:mt-10 lg:mt-12 pt-6 sm:pt-8 text-center text-gray-400">
          <p className="text-xs sm:text-sm">&copy; {currentYear} TravStaytion. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
